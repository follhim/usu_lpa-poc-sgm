...
```{r}
lpa_data <- subset(data, select = c("religious",
                                    "relcom", 
                                    "relconnect",
                                    "serviceattendance", 
                                    "nora"))
...
# saveRDS(lpa1, here("analysis", "model_objects", "lpa1_0418_white.RData"))
lpa1 <- readRDS(here("analysis", "model_objects", "lpa1_0418_white.RData"))
```
...
```{r}
lpa1_solution <- lpa1[[3]]
lpa1_class4 <- class_prob(lpa1[[3]])
