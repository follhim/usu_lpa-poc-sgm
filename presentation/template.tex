...
\hypersetup{colorlinks=true,urlcolor=beamer@UIUCblue,linkcolor=beamer@UIUCblue,
...
% Custom title page template: icons below affiliation, acknowledgment moved slightly further up and left-aligned
$if(acknowledgment)$
\defbeamertemplate{title page}{custom}[1][]
{
  ...
  \begingroup
    ...
    \end{beamercolorbox}
    % --- ICONS BELOW AFFILIATION, ABOVE ACKNOWLEDGMENT ---
    \begin{beamercolorbox}[sep=8pt,center,#1]{icons}
      \includegraphics[height=1.5em]{academicons--open-data.pdf}
      \hspace{1.5em}
      \includegraphics[height=1.5em]{academicons--osf-square.pdf}
    \end{beamercolorbox}
    % --- ACKNOWLEDGMENT MOVED UP SLIGHTLY MORE AND LEFT ALIGNED ---
    \vspace{0.1em} % Change from 1em to 0.1em for an even slighter upward move
    \begin{beamercolorbox}[sep=4pt,left,#1]{acknowledgment}
      \raggedright
      \scriptsize $acknowledgment$
    \end{beamercolorbox}
    % --------------------------------
